...
class TestSpice():
    ...
    def runspectre(self,dict_parameters,alter_list=[]):
        ...
        if self.simulator == 'spectre':
            ...
            commandline = 'cd ' + self.trash_folder + '; spectre test.scs  =log spectre.log -f psfascii'
        elif self.simulator == 'aps_ascii':
            commandline = 'cd ' + self.trash_folder + '; spectre test.scs +aps =log aps.log -f psfascii'
        elif self.simulator == 'apsplus_ascii':
            commandline = 'cd ' + self.trash_folder + '; spectre test.scs ++aps =log apsplus.log -f psfascii'
        elif self.simulator == 'afs_ascii':
            commandline = 'cd ' + self.trash_folder + '; afs test.scs -f psfascii --nolog >& afs.log' 
        if self.verbose:
