...
# AMPSE 
This is the repository of IPs of the group in USC who is developing Analog Mixed-signal Parameter Search Engine (AMPSE). You can download IPs generated by AMPSE or parameterized IPs with neural network based parameter-metric regression models. Watch this repository and follow [USCPOSH on GitHub](https://github.com/USCPOSH?tab=repositories) for our further updates!

## USC POSH Final Reports
- [USC_POSH_FINAL_REPORT (full)](https://drive.google.com/file/d/15z99bcgrk3dqVAfUTTuOd58566zrXwn8/view?usp=share_link)
- [USC_POSH_FINAL_REPORT (short)](https://github.com/USCPOSH/AMPSE/blob/master/Documentation/USC_POSH_FINAL_REPORT_short.pdf)
