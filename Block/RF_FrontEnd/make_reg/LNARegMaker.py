...
dataset = pd.read_csv('/home/mostafa/workarea_POSH/RF_FrontEnd/datasets/LNA_Dataset_modified.csv',header=None)

dataset=dataset.dropna()

X = np.array(dataset.iloc[1:, 0:4].values,dtype='float64') # Selecting the parameters
y = np.array(dataset.iloc[1:, 4:].values,dtype='float64') # Selecting the metrics
...
lst_metric_names=['Center Frequency (GHz)','Output Impedance (Ohm)','Power (mW)', 'Gain (dB)','SFDR','SNR','ENOB']
lst_metric_coef=[1e-9,1,1,1,1,1,1]
