...
name  = 'sh28'
addr = '/home/mostafa/workarea_POSH/RF_FrontEnd/reg_files/SH/'
...
lst_metric_names = ['Power (uW)', 'Output Amp. pp (V)','Tracking Bandwidth(GHz)', 'ENOB (bit)','SNR (dB)','SFDR (dB)' ]
lst_metric_coef  = [1e6,1,1,1,1,1]
