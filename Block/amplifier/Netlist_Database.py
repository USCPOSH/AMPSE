...
class Folded_Cascode_spice(Netlists):
    ...
    def __init__(self, tech = 45, testfolder =None):
        ...
        if tech ==32:
            ...
            self.testfolder = home_address + '/Garbage/foldedcascode_cmfb_32_1_1' if testfolder ==None else home_address + '/Garbage/' + testfolder
        ...
        if tech ==14:
            ...
            self.testfolder = home_address + '/Garbage/foldedcascode_cmfb_14_1_1' if testfolder ==None else home_address + '/Garbage/' + testfolder
    ...
    def make_metrics(self):
        z = [10,12,13,14,16,17,18,23,24,25,26,27,28,29,30,47]
...
class ClassAB_spice(Netlists):
    ...
    def __init__(self, tech = 45, testfolder =None):
        if tech ==45:
            ...
            self.testfolder = home_address + '/Garbage/classAB_45_2_1' if testfolder ==None else home_address + '/Garbage/' + testfolder
        ...
        if tech ==32:
            ...
            self.testfolder = home_address + '/Garbage/classAB_32_2_1' if testfolder ==None else home_address + '/Garbage/' + testfolder
        ...
        if tech ==14:
            ...
            self.testfolder = home_address + '/Garbage/classAB_14_2_1' if testfolder ==None else home_address + '/Garbage/' + testfolder
...
if __name__ == '__main__':
    ...
    fc.put_on_csv(tedad=50, outcsv ='/home/Pedram30may/Desktop/amplifier/Datasets/foldedcascode_cmfb_PTM45_v2.csv', do_header = True)
