...
class Folded_Cascode_spice(Netlists):
    ...
    def __init__(self, tech = 45, testfolder =None):
        if tech ==45:
            self.testbench = home_address + '/Netlists/foldedcascode_cmfb_PTM45nm.scs' # change to your netlist 
            self.testfolder = home_address + '/Garbage/foldedcascode_cmfb_45' if testfolder ==None else home_address + '/Garbage/' + testfolder # change to point to the temp folder
            
			# modify according to your parameter range and sweep step
            ...
            # change according to your netlist file
            ...
            # point where the final dataset will be saved
    ...
    def make_metrics(self):
		# change according to the line of interest in .measure file 
...
if __name__ == '__main__':
	...
	# main program, will be executed tedad number of times
