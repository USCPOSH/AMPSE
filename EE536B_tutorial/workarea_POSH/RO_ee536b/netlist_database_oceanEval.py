...
from spectreIOlib import TestSpice, Netlists,search_oceanEval_result_row_number
import spectreIOlib
import time
...
if __name__ == '__main__':
    ...
    INV.put_on_csv(tedad=20,outcsv = home_address + '/datasets/tb_inv.csv',do_header = True) # tedad stands for the number of samples you want to generate. You also need to change the path which stores the training dataset.
